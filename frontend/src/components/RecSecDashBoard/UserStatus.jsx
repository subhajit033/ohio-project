...
const UserStatus = ({ mainAdmin }) => {
  ...
  return (
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div
          onClick={() => navigate('/dashboard/admin/userStatus/approved')}
          className="text-center bg-gray-200 p-4 border-b-4 border-green-600 rounded-md cursor-pointer"
        >
